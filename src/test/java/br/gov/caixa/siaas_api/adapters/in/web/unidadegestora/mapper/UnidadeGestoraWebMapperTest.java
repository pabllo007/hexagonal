...
class UnidadeGestoraWebMapperTest {
    ...
    void toResponse_deveMapear_quandoTipoExistir() {
        ...
        tipo.setNuTipoUnidadeGestora(NU_TIPO_UNIDADE_GESTORA);
        tipo.setNoTipoUnidadeGestora(TIPO_UNIDADE_GESTORA);

        GrupoTrabalho grupoTrabalho = new GrupoTrabalho();
        grupoTrabalho.setNuGrupoTrabalho(NU_GRUPO_TRABALHO);
        grupoTrabalho.setNoGrupoTrabalho(NO_GRUPO_TRABALHO);
        ...
        ug.setGrupoTrabalho(grupoTrabalho);
        ...
        assertEquals(NU_UNIDADE, r.nuUnidade());
    ...
    void toResponse_deveMapear_quandoTipoForNull() {
        ...
        assertEquals(NU_UNIDADE_GESTORA, r.nuUnidadeGestora());
        assertEquals(NO_UNIDADE_GESTORA, r.noUnidadeGestora());
        assertNull(r.notipoUnidadeGestora());
